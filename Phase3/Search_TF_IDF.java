...
public class Search_TF_IDF {
	...
	public static HashMap<Integer, ArrayList<Double>> myHashMap = new HashMap<Integer, ArrayList<Double>>();
	public static HashMap<String, Double> map2=new HashMap<String, Double>();
	public static HashMap<Integer, Double> map1=new HashMap<Integer, Double>();
